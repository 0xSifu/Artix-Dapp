...
function Calculator() {
    ...
    const [sartixAmount, setSartixAmount] = useState(trimmedSartixBalance);
    ...
    const calcInitialInvestment = () => {
        const sartix = Number(sartixAmount) || 0;
        const price = parseFloat(priceAtPurchase) || 0;
        const amount = sartix * price;
    ...
    }, [days, rewardYield, futureMarketPrice, sartixAmount]);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-apy">
                                            <p className="calculator-card-metrics-title">ARTIX Price</p>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-index">
                                            <p className="calculator-card-metrics-title">Your sARTIX Balance</p>
                                            <p className="calculator-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedSartixBalance} sARTIX</>}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="calculator-card-area">
                            <div>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">ARTIX Amount</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                                    value={sartixAmount}
                                                    onChange={e => setSartixAmount(e.target.value)}
                                                    labelWidth={0}
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setSartixAmount(trimmedSartixBalance)} className="stake-card-action-input-btn">
                                                                <p>Max</p>
                                                            </div>
                                                        </InputAdornment>
                                                    }
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">ARTIX price at purchase ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">Future ARTIX market price ($)</p>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <div className="calculator-user-data">
                                    ...
                                    <div className="data-row">
                                        <p className="data-row-name">ARTIX rewards estimation</p>
                                        <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} ARTIX</>}</p>
                                    </div>
                                    <div className="data-row">
