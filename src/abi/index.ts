...
export { abi as MemoTokenContract } from "./sArtixRev1.json";
export { abi as TimeTokenContract } from "./ArtixERC20TokenRev1.json";
...
export { abi as StakingContract } from "./ArtixStakingRev1.json";
export { abi as StakingHelperContract } from "./ArtixStakingHelperRev1.json";
...
export { abi as SartixTokenContract } from "./sArtixRev1.json";
export { abi as ArtixTokenContract } from "./ArtixERC20TokenRev1.json";
export { abi as wAXTokenContract } from "./tokens/wMemoContract.json";