...
function TimeMenu() {
    ...
    const SARTIX_ADDRESS = addresses.SARTIX_ADDRESS;
    const ARTIX_ADDRESS = addresses.ARTIX_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://www.traderjoexyz.com/#/trade?inputCurrency=&outputCurrency=${ARTIX_ADDRESS}`} target="_blank"/>
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("ARTIX", ARTIX_ADDRESS)}>
                                        <p>ARTIX</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("sARTIX", SARTIX_ADDRESS)}>
                                        <p>sARTIX</p>
                                    </div>
                                </div>
                            )}
